...
- Get up and running quickly with the Tenderizers SDK:
  - [**Installation**: Instructions for installing the SDK.](/installingSDK/overview#installation)
  - [**Basic Usage**: Simple examples to help you start using the SDK right away.](/overview#comprehensive-integration-example-with-default-web3-configuration)

## Web3 Setup

- Comprehensive guides to setting up web3 with the Tenderizers SDK:
  - [**Using the SDK Supplied Provider**: Detailed instructions on how to use the default provider supplied by the SDK](/Integration/integration#web3provider-internal-structure).

## Tenderizers Setup

- [Instructions for setting up Tenderizers within your application.](/configration/configInfo#tenderizers-configuration)

## Token Setup

- [Instructions for configuring tokens within your application.](/configration/configInfo#tokens-configuration)

## Iframe Integration

- [Guidance on integrating the SDK within an iframe for enhanced modularity and isolation](/Integration/iframeIntegration#type-definitions).

## Theming Setup

- [Learn how to customize the appearance and theme of your application using the Tenderizers SDK](/theme/themeProvider).
