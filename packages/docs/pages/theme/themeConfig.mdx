...
The `BrandPalette` interface defines the structure of the theme object used to
customize the appearance of your application.
It includes definitions for spacing, fonts, and color schemes for both light and dark modes.
...
`spacing`: A string defining the spacing used throughout the theme.

`fonts`: An object specifying the font details.

`name`: The name of the font.

`familyUrl`: The URL to the font family.

`colors`: An object containing color schemes for both light and dark modes.

`lightMode`: An object defining the colors for light mode.

`darkMode`: An object defining the colors for dark mode.
